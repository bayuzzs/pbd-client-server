...
<body>
    ...
    <div class="min-h-screen flex items-center justify-center w-full dark:bg-gray-950">
        ...
        <div class="bg-white dark:bg-gray-900 shadow-md rounded-lg px-8 py-6 min-w-[400px]">
